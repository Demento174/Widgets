...
/***/ "./resources/js/modules/DrugAndDrop.js":
/*!*********************************************!*\
  !*** ./resources/js/modules/DrugAndDrop.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DrugAndDrop; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function DrugAndDrop(element) {
    _classCallCheck(this, DrugAndDrop);
    ...
    value: function upDown() {
      ...
      this.element.onmousedown = function (e) {
        ...
        var moveAt = function moveAt(e) {
          if (e.pageY >= window.innerHeight - _this.element.clientHeight / 100 || e.pageY <= _this.element.clientHeight / 100) {
            return false;
          }

          _this.element.style.top = e.pageY - _this.element.offsetHeight / 2 + 'px';
          return false;
        }; // moveAt(e);
...
/***/ "./resources/widgets/tradeIn/index.js":
/*!********************************************!*\
  !*** ./resources/widgets/tradeIn/index.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _src_connect_GetItemsClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/connect/GetItemsClass */ "./resources/widgets/tradeIn/src/connect/GetItemsClass.js");
/* harmony import */ var _src_front_AssemblyElementsFront__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/front/AssemblyElementsFront */ "./resources/widgets/tradeIn/src/front/AssemblyElementsFront.js");
/* harmony import */ var _js_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../js/common */ "./resources/js/common.js");




window.tradeInKey = Object(_js_common__WEBPACK_IMPORTED_MODULE_3__["getHashKey"])();
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(new _src_connect_GetItemsClass__WEBPACK_IMPORTED_MODULE_1__["default"]({
            table: 'mark'
          }));

        case 2:
          marks = _context.sent;
          new _src_front_AssemblyElementsFront__WEBPACK_IMPORTED_MODULE_2__["default"](marks);
...
/***/ "./resources/widgets/tradeIn/src/front/AssemblyElementsFront.js":
/*!**********************************************************************!*\
  !*** ./resources/widgets/tradeIn/src/front/AssemblyElementsFront.js ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AssemblyElementsFront; });
/* harmony import */ var _SideWindowFront__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SideWindowFront */ "./resources/widgets/tradeIn/src/front/SideWindowFront.js");
/* harmony import */ var _ModalWindowFront__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ModalWindowFront */ "./resources/widgets/tradeIn/src/front/ModalWindowFront.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var AssemblyElementsFront =
/*#__PURE__*/
function () {
  function AssemblyElementsFront(marks) {
    _classCallCheck(this, AssemblyElementsFront);

    this.sideWindow = new _SideWindowFront__WEBPACK_IMPORTED_MODULE_0__["default"](marks);
    this.modalWindow = new _ModalWindowFront__WEBPACK_IMPORTED_MODULE_1__["default"](marks);
    this.assembly();
  }

  _createClass(AssemblyElementsFront, [{
    key: "assembly",
...
/***/ "./resources/widgets/tradeIn/src/front/ModalWindowFront.js":
/*!*****************************************************************!*\
  !*** ./resources/widgets/tradeIn/src/front/ModalWindowFront.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModalWindowFront; });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../config */ "./resources/widgets/tradeIn/config.js");
/* harmony import */ var _connect_GetItemsClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../connect/GetItemsClass */ "./resources/widgets/tradeIn/src/connect/GetItemsClass.js");
/* harmony import */ var _js_modules_ApplicationSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../js/modules/ApplicationSettings */ "./resources/js/modules/ApplicationSettings.js");
...
var elements = _config__WEBPACK_IMPORTED_MODULE_2__["Elements"].modalWindow;
var classes = _config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow;

var ModalWindowFront =
/*#__PURE__*/
function () {
  function ModalWindowFront(marks) {
    _classCallCheck(this, ModalWindowFront);

    if (_typeof(marks) !== 'object' || marks.length < 1) {
      throw 'Marks do not come';
    }

    this.marks = marks;
    this.modalWindow = new _js_modules_CreateElement__WEBPACK_IMPORTED_MODULE_1__["default"](elements);
    this.assemblyParserCars();
    this.assemblySelect();
    return this.modalWindow;
  }

  _createClass(ModalWindowFront, [{
    key: "assemblySelect",
    value: function assemblySelect() {
      var _this = this;
      ...
      this.marks.forEach(function (item) {
        ...
        _this.modalWindow.querySelector(".".concat(classes.select.mark)).append(option);
      });
    }
  }, {
    key: "assemblyParserCars",
    value: function assemblyParserCars() {
      var _this2 = this;

      var cars, element;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function assemblyParserCars$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(new _connect_GetItemsClass__WEBPACK_IMPORTED_MODULE_3__["default"]({
                table: 'cars'
              }));

            case 2:
              cars = _context.sent;
              element = this.modalWindow.querySelector(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.carCard)).cloneNode(true);
              this.modalWindow.querySelector(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.carCard)).remove();
              cars.forEach(function (item) {
                var cloneElement = element.cloneNode(true);
                cloneElement.querySelector('img').src = item.img;
                cloneElement.querySelector(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.carCardTitle)).innerText = "".concat(item.mark, " ").concat(item.model);
                cloneElement.querySelector(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.carCardEquipment)).innerText = "".concat(item.equipment);
                cloneElement.querySelectorAll(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.carCardPriceOld, " span"))[0].innerText = "".concat(item.price);
                var ApplicationSettingsCloneElement = new _js_modules_ApplicationSettings__WEBPACK_IMPORTED_MODULE_4__["default"](cloneElement);
                ApplicationSettingsCloneElement.addAttribute([{
                  title: _config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].attributes.cardPrice,
                  value: item.price
                }]);
                ApplicationSettingsCloneElement.addEvents([_config__WEBPACK_IMPORTED_MODULE_2__["events"].carSelection], cloneElement);

                _this2.modalWindow.querySelector(".".concat(_config__WEBPACK_IMPORTED_MODULE_2__["ElementsConfig"].classes.modalWindow.step_2)).append(cloneElement);
              });
...
/***/ "./resources/widgets/tradeIn/src/front/SideWindowFront.js":
/*!****************************************************************!*\
  !*** ./resources/widgets/tradeIn/src/front/SideWindowFront.js ***!
  \****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SideWindowFront; });
/* harmony import */ var _js_modules_CreateElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../js/modules/CreateElement */ "./resources/js/modules/CreateElement.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../config */ "./resources/widgets/tradeIn/config.js");
/* harmony import */ var _js_modules_DrugAndDrop__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../js/modules/DrugAndDrop */ "./resources/js/modules/DrugAndDrop.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var elements = _config__WEBPACK_IMPORTED_MODULE_1__["Elements"].sideWindowFront;
var classes = _config__WEBPACK_IMPORTED_MODULE_1__["ElementsConfig"].classes.sideWindowFront;

var SideWindowFront =
/*#__PURE__*/
function () {
  function SideWindowFront(marks) {
    _classCallCheck(this, SideWindowFront);
    ...
    this.marks = marks;
    this.sideWindow = new _js_modules_CreateElement__WEBPACK_IMPORTED_MODULE_0__["default"](elements);
    this.assemblySelect();
    this.drugAndDrop();
    return this.sideWindow;
  }

  _createClass(SideWindowFront, [{
    key: "assemblySelect",
    value: function assemblySelect() {
      var _this = this;
      ...
      this.marks.forEach(function (item) {
        ...
        _this.sideWindow.querySelector(".".concat(classes.select)).append(option);
      });
    }
  }, {
    key: "drugAndDrop",
    value: function drugAndDrop() {
      var drugAndDrop = new _js_modules_DrugAndDrop__WEBPACK_IMPORTED_MODULE_2__["default"](this.sideWindow);
      drugAndDrop.upDown();
    }
  }]);

  return SideWindowFront;
}();
...
/***/ 1:
/*!**************************************************!*\
  !*** multi ./resources/widgets/tradeIn/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\YandexDisk\Work\localhost\Demento\Cars\resources\widgets\tradeIn\index.js */"./resources/widgets/tradeIn/index.js");
